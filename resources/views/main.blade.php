    ...
    <header class="bg-transparent absolute top-0 left-0 w-full flex items-center z-10">
        <div class="container">
            <div class="flex items-center justify-between relative">
                <div class="px-4">
                    <a href="#home" class="font-bold text-lg text-cyan-500 block py-6">Suban</a>
                </div>
                <div class="flex items-center px-4">
                    <button id="hamburger" name="hamburger" type="button" class="block absolute right-4 lg:hidden">
                        <span class="hamburger-line transition duration-400 ease-in-out origin-top-left"></span>
                        <span class="hamburger-line transition duration-400 ease-in-out"></span>
                        <span class="hamburger-line transition duration-400 ease-in-out origin-bottom-left"></span>
                    </button>
                    <nav id="nav-menu" class="hidden absolute py-5 bg-white shadow-lg rounded-lg max-w-[250px] w-full right-4 top-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none">
                        <ul class="block lg:flex">
                            <li class="group">
                                <a href="#home" class="text-base text-slate-950 py-2 mx-8 flex group-hover:text-cyan-500">Home Page</a>
                            </li>
                            <li class="group">
        ...
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full self-center px-4 lg:w-1/2">
                    <h1 class="text-base font-semibold text-cyan-500 md:text-xl">Hi Everyone 🙌, I am 
                        <span class="block font-bold text-slate-950 text-4xl mt-1 lg:text-5xl">Ahmad Maulana Subandrio</span>
                    </h1>
                ...
                <div class="w-full self-end px-4 lg:w-1/2">
                    <div class="relative mt-20 lg:mt-0 lg:right-0">
                        <img src="{{ asset('assets/profile.png') }}" alt="Ahmad Maulana Subandrio" class="max-w-full mx-auto">
                        <span class="absolute -bottom-0 -z-10 left-1/2 -translate-x-1/2 md:scale-125">
                            <svg width="400" height="400" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                                <path fill="#22D3EE" d="M59.8,-25.8C64.8,-3.9,47.5,18.8,24.8,35.7C2,52.6,-26.1,63.7,-42.3,53.1C-58.5,42.6,-62.8,10.4,-53.7,-17C-44.7,-44.5,-22.3,-67.1,2.5,-67.9C27.4,-68.8,54.7,-47.7,59.8,-25.8Z" transform="translate(100 100) scale(1.0)" />
                            </svg>
                        </span>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full px-4 mb-10 lg:w-1/2">
                    ...
                    <h2 class="font-bold text-slate-950 text-3xl mb-5 max-w-md lg:text-4xl">My journey to becoming a junior web programmer!</h2>
                    <ul role="list" class="py-3">
                ...
                <div class="w-full px-4 lg:w-1/2">
                    <h3 class="font-semibold text-slate-950 text-2xl mb-3 lg:text-3xl lg:pt-10">Let's be friends</h3>
                    <p class="font-medium text-base text-slate-500 mb-5 lg:text-lg">Let's be friends with me through some of my social media, don't be afraid to start a conversation. 👌</p>
                    <div class="flex items-center">
                        {{-- instagram --}}
                        <a href="https://www.instagram.com/subannnnnnnnnn/" target="" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center text-slate-500 border border-slate-300 hover:border-cyan-500 hover:bg-cyan-500 hover:text-white">
                        ...
                        {{-- whatsapps --}}
                        <a href="https://wa.me/6281217559077" target="" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center text-slate-500 border border-slate-300 hover:border-cyan-500 hover:bg-cyan-500 hover:text-white">
                            <svg class="fill-current" width="20" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {{-- x --}}
                        <a href="https://x.com/RioBangla_" target="" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center text-slate-500 border border-slate-300 hover:border-cyan-500 hover:bg-cyan-500 hover:text-white">
                            <svg class="fill-current" width="20" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <title>X</title>
                        ...
                        {{-- github --}}
                        <a href="https://github.com/ahmadrioyo" target="" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center text-slate-500 border border-slate-300 hover:border-cyan-500 hover:bg-cyan-500 hover:text-white">
                            <svg class="fill-current" width="20" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <title>GitHub</title>
                        ...
                        {{-- tiktok --}}
                        <a href="https://www.tiktok.com/@banglaaaaaa" target="" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center text-slate-500 border border-slate-300 hover:border-cyan-500 hover:bg-cyan-500 hover:text-white">
                            <svg class="fill-current" width="20" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <title>TikTok</title>
