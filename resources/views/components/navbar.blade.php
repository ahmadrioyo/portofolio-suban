...
<nav class="bg-gray-800" x-data="{ isOpen: false }">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center">
            ...
            {{-- <img class="size-8" src="https://tailwindui.com/plus/img/logos/mark.svg?color=indigo&shade=500" alt="Your Company"> --}}
                <h2 class="text-3xl tracking-tight font-bold text-blue-500 hover:text-white">Subannnnnnnnnn.</h2>
            </div>
        ...
        <div class="hidden md:block">
            ...
            <div class="relative ml-3">
                ...
                <button type="button" @click="isOpen = !isOpen" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    ...
                    <img class="size-8 rounded-full" type="image/jpeg" src="{{ asset('assets/logo.jpg') }}" alt="">
                </button>
                </div>
                <div 
                    x-show="isOpen"
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            ...
            {{-- <x-nav-link class="block text-base" href="/about" :active="request()->is('about')">About Me</x-nav-link> --}}
            {{-- <x-nav-link class="block text-base" href="/project" :active="request()->is('project')">Projects</x-nav-link> --}}
            {{-- <x-nav-link class="block text-base" href="/contact" :active="request()->is('contact')">Contacts</x-nav-link> --}}
